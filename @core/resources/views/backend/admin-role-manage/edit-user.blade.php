                       ...
                       <div class="header-wrap d-flex justify-content-between mb-4">
                        ...
                        <form action="{{route('admin.user.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  id="facebook_url" name="facebook_url" value="{{$admin->facebook_url}}">
                            </div>

                            <div class="form-group">
                                <label for="email">{{__('Twitter URL')}}</label>
                                <input type="text" class="form-control"  id="twitter_url" name="twitter_url" value="{{$admin->twitter_url}}">
                            </div>

                            <div class="form-group">
                                <label for="email">{{__('Instagram URL')}}</label>
                                <input type="text" class="form-control"  id="instagram_url" name="instagram_url" value="{{$admin->instagram_url}}">
                            </div>

                            <div class="form-group">
                                <label for="email">{{__('Linkedin URL')}}</label>
                                <input type="text" class="form-control"  id="linkedin_url" name="linkedin_url" value="{{$admin->linkedin_url}}">
                            </div>
