...
@section('page-title')
    ...
    <li class="list-item"><a href="#">{{__('Edit Profile')}}</a></li>
@endsection
        ...
        <form action="{{route('user.profile.update')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input type="text" class="form-control"  id="facebook_url" name="facebook_url" value="{{$user_details->facebook_url}}">
                </div>

                <div class="form-group col-lg-4">
                    <label for="email">{{__('Twitter URL')}}</label>
                    <input type="text" class="form-control"  id="twitter_url" name="twitter_url" value="{{$user_details->twitter_url}}">
                </div>

                <div class="form-group col-lg-4">
                    <label for="email">{{__('Instagram URL')}}</label>
                    <input type="text" class="form-control"  id="instagram_url" name="instagram_url" value="{{$user_details->instagram_url}}">
                </div>

                <div class="form-group col-lg-4">
                    <label for="email">{{__('Linkedin URL')}}</label>
                    <input type="text" class="form-control"  id="linkedin_url" name="linkedin_url" value="{{$user_details->linkedin_url}}">
                </div>
