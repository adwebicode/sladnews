...
class SocialMediaWidgetFour extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $settings['social_04'];
        $social_icon_markup = '';
        $colors = ['facebook','twitter', 'youtube','instagram','linkedin','pinterest'];
        $repeater_data_icons = $repeater_data['icon_'.$current_lang] ?? [];
        foreach ($repeater_data_icons as $key => $icon) {
            $icon = $icon;
...
SOCIALICON;
    ...
    return <<<HTML
         <div class="widget">
                <div class="social-link style-03 v-02">
