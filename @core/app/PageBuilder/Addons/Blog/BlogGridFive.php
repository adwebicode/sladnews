...
class BlogGridFive extends PageBuilderBase
{
    use LanguageFallbackForPageBuilder;

    public function preview_image()
    {
        return 'blog-page/blog-grid-05.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $heading_text = $this->setting_item('heading_text_'.$current_lang);
...
ITEM;
 ...
 return <<<HTML
  <div class="recent-news-area-wrapper index-04" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="recent-news-inner-area three-column">
                    <div class="row">
                        {$blog_markup}
                    </div>
