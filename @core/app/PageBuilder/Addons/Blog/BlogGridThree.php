 ...
 $blog_markup .= <<<HTML
    <div class="col-md-6 {$columns}">
        <div class="blog-grid-style-03 small-02">
            <div class="img-box">
             <a href="{$route}"> <div class="background-img lazy"{$image} data-height="250"></div></a>
            </div>
            <div class="content">
                <div class="post-meta">
...
HTML;
 ...
 return <<<HTML
    <div class="blog-area-wrapper Political-blog-grid-wrapper" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
        <div class="container">
            <div class="row">
