...
namespace Spatie\Analytics {
     ...
     * @see \Illuminate\Support\Traits\Macroable::macro
     * @method static void macro(string $name, callable|object $macro)
     * @see \Spatie\Analytics\Analytics::performQuery
     * @method static array|null performQuery(\Spatie\Analytics\Period $period, string $metrics, array $others = [])
     * @see \Spatie\Analytics\Analytics::fetchTopReferrers
     * @method static \Illuminate\Support\Collection fetchTopReferrers(\Spatie\Analytics\Period $period, int $maxResults = 20)
     * @see \Spatie\Analytics\Analytics::fetchUserTypes
     * @method static \Illuminate\Support\Collection fetchUserTypes(\Spatie\Analytics\Period $period)
     * @see \Spatie\Analytics\Analytics::fetchVisitorsAndPageViews
     * @method static \Illuminate\Support\Collection fetchVisitorsAndPageViews(\Spatie\Analytics\Period $period)
     * @see \Spatie\Analytics\Analytics::getAnalyticsService
     * @method static \Google_Service_Analytics getAnalyticsService()
     * @see \Illuminate\Support\Traits\Macroable::mixin
     * @method static void mixin(object $mixin, bool $replace = true)
     * @see \Spatie\Analytics\Analytics::fetchTotalVisitorsAndPageViews
     * @method static \Illuminate\Support\Collection fetchTotalVisitorsAndPageViews(\Spatie\Analytics\Period $period)
     * @see \Spatie\Analytics\Analytics::fetchTopBrowsers
     * @method static \Illuminate\Support\Collection fetchTopBrowsers(\Spatie\Analytics\Period $period, int $maxResults = 10)
     * @see \Spatie\Analytics\Analytics::fetchMostVisitedPages
     * @method static \Illuminate\Support\Collection fetchMostVisitedPages(\Spatie\Analytics\Period $period, int $maxResults = 20)
     * @see \Spatie\Analytics\Analytics::getViewId
     * @method static string getViewId()
     * @see \Illuminate\Support\Traits\Macroable::hasMacro
     * @method static bool hasMacro(string $name)
     * @see \Spatie\Analytics\Analytics::setViewId
     * @method static void setViewId(string $viewId)
     */
